$('#text').on('input keyup change', function () {
			...
			$('#name').on('input keyup change', function () {
        		var val = $('#name').val();
        		var url = 'https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2F'+val+'&tabs=messages&width=340&height=500&small_header=true&adapt_container_width=true&hide_cover=false&show_facepile=true&appId=150102318439204';
